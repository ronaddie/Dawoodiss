...
Cyberspace is a collection of entities (agents, devices, servers, and more) Figure \ref{policiesfig}. Each entity has a {\em policy}. The policy protects the entity where it is located, and also declares conditions it commits to, for other agents or devices. A policy is a statement of obligations and conditions.
