...
In this research, we review, in Chapter 2,  the existing literature to determine the definitions provided for the term cybersecurity in current literature. We now  propose a new definition, with considerable advantages in clarity and simplicity, 
...
\item {In section? and \Chapter5, we tried to show that cybersecurity inference graphs can significantly contribute to the development of, and validation of cybersecurity and also that rigorous validation of cybersecurity is not necessarily as complex as previously thought.
%\begin{itemize}
